...
# 2.2.5 urlopen() 함수 - HTTPCookieProcessor 클래스로 데이터를 포함하여 요청
# >python
...
# 2.2.6 urlopen() 함수 - ProxyHandler 및 ProxyBasicAuthHandler 클래스로 프록시 처리
...
# 위 예제들은 2.2.2-1~6번 예제였음 2-1~6번 예제라 할 수도 있고.. 음.. (추후 주석 수정)

# 여기까진 실습도 완료. 이 후엔, 책을 우선 읽은 뒤 실습하면서 이론을 한 번 더 복습하면서, 살습한 소스 코드를 깃헙에 올리기로.210206
